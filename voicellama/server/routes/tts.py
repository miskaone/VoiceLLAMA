...
class BatchTTSResponse(BaseModel):
    ...
    results: List[dict] = Field(description="List of results with audio data")
...
async def websocket_tts(websocket: WebSocket):
    ...
    logger.info("WebSocket client connected", extra={'ws_clients': len(websocket_clients)})
    ...
    try:
        ...
        logger.info("WebSocket client disconnected", extra={'ws_clients': len(websocket_clients)})
